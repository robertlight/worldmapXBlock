...
//          this.ul.style.display = ( this.bExpanded || !parent ) ? "" : "none";
            this.li.style.display = ( data.hidden ? "none" : "visible" );      //ADDED TO V1.2.5
...
//              self.tree.logDebug("appendAjax().success");
        ...
        window.console.log("ajax options: "+JSON.stringify(options));
...
$.ui.dynatree.nodedatadefaults = {
    ...
    hidden: false, // is node hidden                              //ADDED TO V1.2.5
